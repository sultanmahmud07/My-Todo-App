...
export const TodoCard = ({ todo }: { todo: TodoItem }) => {
    ...
    return (
        <>
            <div
                key={todo.id}
                className="bg-white p-5 rounded-md shadow-sm border-[#FEE2E2] hover:shadow-md"
            >
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            ...
                            className="p-2 bg-[#EEF7FF] text-blue-600 rounded-lg"
                        >
                            <PencilLine size={15} />
                        </button>
                        ...
                        <button
                            ...
                            className="p-2 bg-[#EEF7FF] text-red-600 rounded-lg"
                        >
                            <Trash size={15} />
                        </button>
                    </div>
